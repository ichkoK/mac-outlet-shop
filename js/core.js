...
const renderItem = (item) => {
   ...
   <div class="main__top-card">
      <label class="main__like-label">
         <input class="main__like-input" type="checkbox" />
         <svg
            class="main__like-svg"
     ...
     C475.078,202.133,457.19,236.016,421.405,271.795z"
      ...
      <h3 class="main__card-title">${item.name}</h3>
      <p class="main__stock-p">
         <span class="main__stock-span">${item.orderInfo.inStock}</span> left in
         stock
      </p>
      <p class="main__price-p">
         Price: <span class="main__price-span">${item.price}</span> $
      </p>
      <button class="main__card-btn btn">Add to card</button>
   </div>
   <div class="main__bottom-card">
      <div class="main__bottom-left">
         <svg class="main__heart" viewBox="0 0 24 24">
            <path
